...
/* WEBPACK VAR INJECTION */(function($) {var mainslider;
var sliding = false;
...
$(document).ready(function () {
    ...
    $(".slide#first").backstretch("./images/slide1.jpg");
    $(".slide#sec").backstretch("./images/slide2.jpg");
    $(".slide#thirth").backstretch("./images/slide3.jpg");
    $(".slide#four").backstretch("./images/slide4.jpg");
    $(".slide#five").backstretch("./images/slide5.jpg");
...
!function (a) {
    var b = function b(_b, c) {
        ...
        this.init = function () {
            ...
            if (a(_b).trigger(l), l.isDefaultPrevented()) return e.currentSlide = j, !1;
